...
static unsigned char dvfd_bitmap_c3[64][5] =
{
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
	{0x0,0x0,0x0,0x0,0x0},
        {0x28, 0x17, 0xe3, 0x8f, 0x11}, //'Ä'
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        ...
        {0x0,0x0,0x0,0x0,0x0},
	{0x0,0x0,0x0,0x0,0x0},
        {0x28, 0x17, 0x63, 0x8c, 0x0e}, //'Ö'
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0xa8, 0x18, 0x63, 0x8c, 0x0e}, //"Ü"
        {0x0,0x0,0x0,0x0,0x0},
	{0x0,0x0,0x0,0x0,0x0},
        {0x30, 0x29, 0x9d, 0x94, 0x0d}, //"ß"

        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
	{0x0,0x0,0x0,0x0,0x0},
        {0x00, 0xe5, 0xa0, 0x8f, 0x1e}, //'ä'
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        ...
        {0x0,0x0,0x0,0x0,0x0},
	{0x0,0x0,0x0,0x0,0x0},
        {0x00, 0xe5, 0x62, 0x8c, 0x0e}, //'ö'
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x00, 0x05, 0x62, 0x8c, 0x0e}, //"ü"
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0}
};

static unsigned char dvfd_bitmap_d0[64][5] =
{
	{0x0,0x0,0x0,0x0,0x0},
	{0xfc, 0x10, 0x7e, 0x08, 0x1f}, //Ё		Russian start
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
	...
	{0xb8, 0x18, 0xe3, 0x8f, 0x11}, //'А' 0xF1 0x38
        {0xfc, 0x18, 0x5e, 0x8c, 0x0f}, //'Б' 0xF1 0x68
        {0xbc, 0x18, 0x5f, 0x8c, 0x0f}, //'В' 0xC3 0x6C
        {0xfc, 0x18, 0x42, 0x08, 0x01}, //'Г' 0x01 0x28
        {0x78, 0x4a, 0x65, 0xfc, 0x11}, //'Д' 0x54 0x72
        {0xfc, 0x10, 0x7e, 0x08, 0x1f}, //'Е' 0xE1 0x68
        {0xd4, 0x5a, 0x5d, 0xad, 0x15}, //'Ж' 0x4E 0x07
        {0x3c, 0x08, 0x19, 0x84, 0x0f}, //'З' 0x42 0x64
        {0xc4, 0x98, 0xeb, 0x8c, 0x11}, //'И' 0x59 0x1C
        {0x28, 0x12, 0x73, 0x9d, 0x11}, //'Й' 0x59 0x1C
        {0xc4, 0x54, 0x46, 0x49, 0x11}, //'К' 0xC3 0x0C
        {0x78, 0x4a, 0x29, 0xad, 0x12}, //'Л' 0x58 0x14
        {0xc4, 0x5d, 0x63, 0x8c, 0x11}, //'М' 0x51 0x1D
        {0xc4, 0x18, 0x7f, 0x8c, 0x11}, //'Н' 0xF1 0x18
        {0xb8, 0x18, 0x63, 0x8c, 0x0e}, //'О' 0x11 0x78
        {0xfc, 0x18, 0x63, 0x8c, 0x11}, //'П' 0x11 0x38

        {0xbc, 0x18, 0x5f, 0x08, 0x01}, //'Р' 0xE1 0x38
        {0xb8, 0x18, 0x42, 0x88, 0x0e}, //'С' 0x01 0x68
        {0x7c, 0x42, 0x08, 0x21, 0x04}, //'Т' 0x44 0x22
        {0xc4, 0x18, 0x15, 0x11, 0x01}, //'У' 0xF0 0x58
        {0x10, 0x57, 0x6b, 0x75, 0x04}, //'Ф' 0x55 0x7A
        {0xc4, 0xa8, 0x88, 0x8a, 0x11}, //'Х' 0x4A 0x05
        {0xc4, 0x18, 0x63, 0xfc, 0x10}, //'Ц' 0x05 0x4A
        {0xc4, 0x18, 0x3d, 0x84, 0x10}, //'Ч' 0xF0 0x18
        {0xd4, 0x5a, 0x6b, 0xad, 0x1f}, //'Ш' 0x55 0x5A
        {0xd4, 0x5a, 0x6b, 0xfd, 0x10}, //'Щ' 0x55 0x5A
        {0x0c, 0x21, 0x9c, 0x94, 0x0e}, //'Ъ' 0x71 0x48
        {0xc4, 0x18, 0x67, 0xad, 0x13}, //'Ы' 0xD5 0x58
        {0x84, 0x10, 0x5e, 0x8c, 0x0f}, //'Ь' 0x71 0x48
        {0xb8, 0x48, 0x35, 0x8c, 0x0e}, //'Э' 0x70 0x70
        {0xa4, 0x5a, 0x6f, 0xad, 0x09}, //'Ю' 0xD3 0x1C
        {0xf8, 0x18, 0x3d, 0x95, 0x11}, //'Я' 0x78 0x38

        {0x00, 0xe0, 0xa0, 0x8f, 0x1e}, //'а' 0xF1 0x38
        {0x70, 0x11, 0x5e, 0x8c, 0x0e}, //'б' 0xF1 0x68
        {0x00, 0xf0, 0xe2, 0x8b, 0x0f}, //'в' 0xC3 0x6C
        {0x00, 0xf0, 0x43, 0x08, 0x01}, //'г' 0x01 0x28
        {0x00, 0xc0, 0xa5, 0xfc, 0x11}, //'д' 0x54 0x72
        {0x00, 0xe0, 0xe2, 0x0f, 0x0e}, //'е' 0xE1 0x68
        {0x00, 0x50, 0xab, 0xab, 0x15}, //'ж' 0x4E 0x07
        {0x00, 0xf0, 0xa0, 0x83, 0x0f}, //'з' 0x42 0x64
        {0x00, 0x10, 0x73, 0x9d, 0x11}, //'и' 0x59 0x1C
        {0x28, 0x12, 0x73, 0x9d, 0x11}, //'й' 0x59 0x1C
        {0x00, 0x10, 0xcb, 0x28, 0x11}, //'к' 0xC3 0x0C
        {0x00, 0xe0, 0xa5, 0x94, 0x11}, //'л' 0x58 0x14
        {0x00, 0x10, 0x77, 0x8d, 0x11}, //'м' 0x51 0x1D
        {0x00, 0x10, 0xe3, 0x8f, 0x11}, //'н' 0xF1 0x18
        {0x00, 0xe0, 0x62, 0x8c, 0x0e}, //'о' 0x11 0x78
        {0x00, 0xf0, 0x63, 0x8c, 0x11}  //'п' 0x11 0x38
};

static unsigned char dvfd_bitmap_d1[64][5] =
{
	{0x00, 0xf0, 0xe2, 0x0b, 0x01}, //'р' 0xE1 0x38
        {0x00, 0xe0, 0x42, 0x88, 0x0e}, //'с' 0x01 0x68
        {0x00, 0xf0, 0x09, 0x21, 0x04}, //'т' 0x44 0x22
        {0x00, 0x10, 0x15, 0x11, 0x01}, //'у' 0xF0 0x58
        {0x10, 0xe2, 0xaa, 0x23, 0x04}, //'ф' 0x55 0x7A
        {0x00, 0x50, 0x1d, 0x71, 0x15}, //'х' 0x4A 0x05
        {0x00, 0x10, 0x63, 0xfc, 0x10}, //'ц' 0x05 0x4A
        {0x00, 0x10, 0xa3, 0x87, 0x10}, //'ч' 0xF0 0x18
        {0x00, 0x50, 0x6b, 0xad, 0x1f}, //'ш' 0x55 0x5A
        {0x00, 0x50, 0x6b, 0xfd, 0x10}, //'щ' 0x55 0x5A
        {0x00, 0x30, 0x84, 0x93, 0x0e}, //'ъ' 0x71 0x48
        {0x00, 0x10, 0xe3, 0xac, 0x13}, //'ы' 0xD5 0x58
        {0x00, 0x10, 0xc2, 0x8b, 0x0f}, //'ь' 0x71 0x48
        {0x00, 0xf0, 0xa0, 0x87, 0x0f}, //'э' 0x70 0x70
        {0x00, 0x90, 0xea, 0xad, 0x09}, //'ю' 0xD3 0x1C
        {0x00, 0xe0, 0xa3, 0x97, 0x11}, //'я' 0x78 0x38

        {0x0,0x0,0x0,0x0,0x0},
        {0x28, 0xe0, 0xe2, 0x0f, 0x0e}, //'ё'			Russian end
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
        {0x0,0x0,0x0,0x0,0x0},
...
static void YWVFDi_DVFDFillChar(u8 i, u8 *str)
{
	int off = 0;
	if (i >= 16)
		return;
	...
	// TODO c2, c4, c5
		case 0xc3:
			...
			YWVFD_Debug("c3 %d\n", *str & 0x3f);
			for (j = 0; j < 5; j++)
				strDvfd[off + i][j] = dvfd_bitmap_c3[*str & 0x3f][j];
		break;
		case 0xd0:
			str++;
			YWVFD_Debug("d0 %d\n", *str & 0x3f);
			for (j = 0; j < 5; j++)
				strDvfd[off + i][j] = dvfd_bitmap_d0[*str & 0x3f][j];
		break;
		case 0xd1:
			str++;
			YWVFD_Debug("d1 %d\n", *str & 0x3f);
			for (j = 0; j < 5; j++)
				strDvfd[off + i][j] = dvfd_bitmap_d1[*str & 0x3f][j];
		break;
		default:
			YWVFDi_DVFDCleanChar(i);
		break;
...
static int lookup_utf8(unsigned char *str, int *v1, int *v2)
{
	...
	*v1 = *v2 = 0;
	...
	switch (*str)
	{
	  	case 0xc2:
			str++;
			*v1 = UTF_C2[*str & 0x3f][0];
			*v2 = UTF_C2[*str & 0x3f][1];
		break;
		case 0xc3:
			str++;
			*v1 = UTF_C3[*str & 0x3f][0];
			*v2 = UTF_C3[*str & 0x3f][1];
		break;
		case 0xc4:
			str++;
...
{
        PANEL_PRINT((TRACE_ERROR, "%d %d", v1, v2));
	int ST_ErrCode = 0 ;
	int number_of_utf8_characters, i;
	if (down_interruptible(&vfd_sem))
	{
